...
const assetTypeValues = ["auto", "decal"]; // , "image", "shirt", "pants", "tshirt", "audio", "animation", "place"];
...
// assetTypeExtensions.audio = [".ogg"];
// assetTypeExtensions.animation = assetTypeExtensions.audio;
